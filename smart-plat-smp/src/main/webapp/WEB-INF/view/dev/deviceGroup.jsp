	...
	<div id="page-container"
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">设备组管理</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">
				设备管理 <small>设备组管理</small>
			</h1>
			<!-- end page-header -->
			<!-- begin panel -->
			<div class="panel panel-inverse" style="height:100%">
				<div class="panel-heading">
					<h4 class="panel-title">设备组管理</h4>
				</div>
					...
					<div class="vertical-box">
						...
						<div class="vertical-box-column p-15">
							<div class="form-group" style="text-align: left;" >
                                ...
                                <form id="addForm" action="preAddDevGroup" method="post">
									<input type="hidden" id="clientId" name="clientId" value=""/>
									<button type="button" id="addGroup" class="btn btn-success m-r-5">添加设备组</button>
                                </form>
								</div>
								<div class="col-md-2 col-sm-2">
								<button type="button" id="delGroup" class="btn btn-success m-r-5">删除设备</button>
								</div>
							</div>
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting" tabindex="0" aria-controls="data-table"
														...
														aria-label="设备组名: activate to sort column descending">设备组名</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1" aria-sort="ascending"

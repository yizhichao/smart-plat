	...
	<div id="page-container"
		...
		<div id="content" style="margin-left:220px;padding:20px 25px;">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">同步老师</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">
				同步数据管理 <small>同步老师</small>
			</h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
							...
							<div id="data-table_wrapper"
								...
								<div class="row">
									<div class="col-sm-12">
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting" tabindex="0" aria-controls="data-table"
														...
														aria-label="短号: activate to sort column descending">短号</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1" aria-sort="ascending"
														aria-label="固定号码: activate to sort column descending">固定号码</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1" aria-sort="ascending"
														aria-label="邮箱: activate to sort column descending">邮箱</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1" aria-sort="ascending"
														aria-label="性别: activate to sort column descending">性别</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1"
														aria-label="生日: activate to sort column ascending">生日</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1" aria-sort="ascending"
														aria-label="昵称: activate to sort column descending">昵称</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1" aria-sort="ascending"
														aria-label="qq: activate to sort column descending">qq</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1" aria-sort="ascending"
														aria-label="家庭住址: activate to sort column descending">家庭住址</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1"
														aria-label="学校: activate to sort column ascending">学校</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1"
														aria-label="职位: activate to sort column ascending">职位</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1"
										...
										<a href="javascript:syncUserData();" id="syncUser"

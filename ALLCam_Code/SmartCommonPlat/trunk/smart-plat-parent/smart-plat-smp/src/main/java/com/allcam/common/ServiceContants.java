...
public interface ServiceContants
{
 ...
 // 组织+用户相关
    ...
    /** 设备类型*/
    String ID_CODE_DEVICE_GATEWAY="01"; //网关设备
    String ID_CODE_DEVICE_VIDEO="02"; 	//视频设备
    String ID_CODE_DEVICE_NETWORK="03";	//网络设备
    String ID_CODE_DEVICE_IO="04";		//IO设备
    
    /** 服务类型*/
    String ID_CODE_SERVICE_RONGHE="01";//融合平台服务
    String ID_CODE_SERVICE_MONITOR="02";//监控平台服务
    String ID_CODE_SERVICE_STREAME="03";//流媒体服务
    //02:监控平台服务
    //03:流媒体服务

package com.allcam.modules.ads.web.controller;
...
import com.allcam.modules.abilityInf.sysversion.impl.CheckSysVersionServiceImpl;
 ...
 */
@Controller
public class AdsController extends BaseController implements ServiceContants
{
    ...
    @Resource
    private CheckSysVersionServiceImpl checkSysVersionService;
    
    @ResponseBody
    @RequestMapping(value = "SYNC_ADS", method = {RequestMethod.POST, RequestMethod.GET})
    public void syncAds(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if (SYNC_ADS.equalsIgnoreCase(msgType))
            {

											...
											<thead>
												<tr role="row">
													<th class="sorting" tabindex="0" aria-controls="data-table"
														...
														aria-label="属性名: activate to sort column descending">属性名</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1" aria-sort="ascending"
														aria-label="状态: activate to sort column descending">属性值</th>
												</tr>
											</thead>
											<tbody>
											 <tr role="row">
												 ...
												 <tr role="row">
													<td>域名</td>
													<td>linux-bwg6.site/192.168.1.112</td>
													</tr>
												 <tr role="row">
													<td>JDK版本</td>
													<td>Java(TM) SE Runtime Environment 1.8.0_76-b13</td>
												</tr>
												 <tr role="row">
													<td>语言</td>
													<td>zh_CN/UTF-8</td>

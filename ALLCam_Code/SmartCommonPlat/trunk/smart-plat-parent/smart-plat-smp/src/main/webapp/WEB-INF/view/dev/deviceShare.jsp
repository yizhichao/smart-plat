	...
	<div id="page-container"
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">设备共享</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">
				设备管理 <small>设备共享</small>
			</h1>
			<!-- end page-header -->
			<!-- begin panel -->
			<div class="panel panel-inverse" style="height:100%">
				<div class="panel-heading">
					<h4 class="panel-title">设备共享情况</h4>
				</div>
						...
						<div class="vertical-box-column p-15">
							<div class="form-group" style="text-align: left;" >
                                ...
                                <form id="allocateForm" action="allocate" method="post">
									...
									<button type="button" id="allocateDev" class="btn btn-success m-r-5">共享设备</button>
                                </form>
								</div>
							</div>
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting" tabindex="0" aria-controls="data-table"
														...
														aria-label="设备名称: activate to sort column descending">设备名称</th>
													<th class="sorting" tabindex="0" aria-controls="data-table"
														rowspan="1" colspan="1" aria-sort="ascending"

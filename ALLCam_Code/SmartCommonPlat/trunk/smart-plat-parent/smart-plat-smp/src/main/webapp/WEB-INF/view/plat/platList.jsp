					...
					<div class="vertical-box">
						...
						<div class="vertical-box-column p-15">
							<div class="form-group" style="text-align: left;" >
								...
								<form id="addForm" action="preAddPlat" method="post">
									<input type="hidden" id="zoneId" name="zoneId" value=""/>
									<input type="hidden" id="zoneName" name="zoneName" value=""/>
									<!-- <button type="button" id="addPlat" class="btn btn-primary">添加平台</button> -->
									<button type="button" id="addPlat" class="btn btn-success m-r-5">添加平台</button>
                                </form>
								</div>
							</div>

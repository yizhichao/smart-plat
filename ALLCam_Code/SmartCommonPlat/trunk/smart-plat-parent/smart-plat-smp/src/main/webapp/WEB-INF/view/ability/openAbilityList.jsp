	...
	<div id="page-container"
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">能力开放管理</a></li>
				<li class="active">能力集</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">
				能力集<small>能力集列表</small>
			</h1>
			<!-- end page-header -->
			<!-- begin panel -->
			<div class="panel panel-inverse" style="height:100%">
				<div class="panel-heading">
					<h4 class="panel-title">能力集</h4>
				</div>
				<div class="panel-body">
				<div class="row">
				<div class="col-md-2 col-sm-2">
					<button type="button" id="allocateDev" class="btn btn-success m-r-5">添加能力集</button>
					</div>
				</div>
				<div class="row">
						...
						<div class="wow fadeInLeft" data-wow-delay="0.2s">
							<div class="service-box">
								<div class="service-desc">
									...
									<img alt="" src="resources/images/4G_1.png" width="220" height="100%">
									<br/>
									<br/>
								...
								<button type="button" id="allocateDev" class="btn btn-success m-r-5">查看详情</button>
							</div>
						</div>
					</div>
					<div class="col-xs-6 col-sm-3 col-md-3">
						<div class="wow fadeInUp" data-wow-delay="0.2s">
							<div class="service-box">
								...
								<div class="service-desc">
									...
									<img alt="" src="resources/images/4G_2.png" width="220" height="100%">
									<br/>
									<br/>
						...
						<div class="wow fadeInUp" data-wow-delay="0.2s">
							<div class="service-box">
								<div class="service-desc">
									...
									<img alt="" src="resources/images/4G_3.png" width="220" height="100%">
									<br/>
									<br/>
						...
						<div class="wow fadeInRight" data-wow-delay="0.2s">
							<div class="service-box">
								<div class="service-desc">
									...
									<img alt="" src="resources/images/4G_4.png" width="220" height="100%">
									<br/>
									<br/>

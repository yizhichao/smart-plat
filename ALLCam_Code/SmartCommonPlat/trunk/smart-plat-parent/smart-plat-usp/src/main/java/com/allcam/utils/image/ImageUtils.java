package com.allcam.utils.image;
...
public class ImageUtils
{
            ...
            int scale, boolean flag)
    {
        try
        {
            ...
            Image image = src.getScaledInstance(width,
                    height,
        ...
        try
        {
            ...
            if (srcWidth > 0 && srcHeight > 0)
            {
                ...
                ImageFilter cropFilter = new CropImageFilter(x, y, width,
                        height);//用于裁剪图像的 ImageFilter 类。此类扩展了基本 ImageFilter 类，可提取现有 Image 中的给定矩形区域，为包含刚提取区域的新图像提供源。也就是它要与 FilteredImageSource 对象结合使用，以生成现有图像的裁剪版本。
